...
public enum ServiceMessage {
     ...
     * 添加关注成功
     */
    ADD_FRIEND_SUCCESS("添加关注成功，在您的关注中可以看到该用户，当对方也关注你时，可以在好友列表中看到"),
    /**
     * 不可重复添加关注
     */
    ALREADY_ADD_FRIEND("您已经关注该用户，不可重复添加关注，需要取消关注请前往关注列表"),
    /**
     * 当前没有好友
     */
     ...
     * 删除好友成功
     */
    DELETE_FRIEND_SUCCESS("对方已从您的关注中移除，将不再接收对方的消息"),
    /**
     * 该好友不存在
     */
    FRIEND_NOT_EXIST("系统找不到该用户的账号"),
    /**
     * 更新好友信息成功
     */
     ...
     * 不可关注自己
     */
    CANNOT_ADD_YOURSELF("不可以关注自己哦"),
    /**
     * 同意好友申请
     */
    AGREE_FRIEND("我们达成了双向关注关系，现在我们可以开始聊天了"),
    /**
     * 不可删除系统账号
     */
