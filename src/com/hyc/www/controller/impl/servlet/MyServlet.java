...
package com.hyc.www.controller.impl.servlet;

import com.hyc.www.controller.constant.ControllerMessage;
import com.hyc.www.provider.BaseProvider;
...
import static com.hyc.www.provider.BaseProvider.toErrorPage;
...
public class MyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        Map<String, BaseProvider>providerMap = (Map<String, BaseProvider>) getServletContext().getAttribute("providerMap");
